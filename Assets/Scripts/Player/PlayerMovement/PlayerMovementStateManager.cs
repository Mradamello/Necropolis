...
public class PlayerMovementStateManager : MonoBehaviour
{
    ...
    PlayerMovementRunState runState = new PlayerMovementRunState();
    PlayerMovementJumpState jumpState = new PlayerMovementJumpState();
    PlayerMovementCrouchState crouchState = new PlayerMovementCrouchState();
    PlayerMovementIdleState idleState = new PlayerMovementIdleState();
